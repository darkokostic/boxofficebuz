app.controller('walkthrough', ['$ionicSideMenuDelegate', '$scope', '$ionicSlideBoxDelegate', '$state', '$rootScope',
 function($ionicSideMenuDelegate, $scope, $ionicSlideBoxDelegate, $state, $rootScope){
